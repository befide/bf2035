...
// console.log(props.data.map((d) => d.data.id));

const treeData = stratify()
  .id((d) => d.data.id)
  .parentId((d) => d.data.parentPath || null)(props.data);

const columns = [
  { field: 'data.id', header: 'id' },
  { field: 'data.label__de', header: 'Label (de)' },
  { field: 'data.label__en', header: 'Label (en)' },
  { field: 'data.befideInventoryOrganizationalLevelCategory', header: 'cate' },
  { field: 'data.peopleCount.uniqueProfessors', header: 'professors' },
  {
    field: 'data.peopleCount.uniqueSeniorScientists',
    header: 'seniorScientists',
  },
  { field: 'data.peopleCount.uniquePostDocs', header: 'postDocs' },
];
</script>
<template>
  <TreeTable :value="props.data" stripedRows tableStyle="min-width: 50rem">
    <Column
...
:root {
  ...
  --home-templates-block-shadow: 0px 5px 10px 0px rgba(0, 0, 0, 0.1);
  --home-templates-line: rgba(0, 0, 0, 0.1);
  --home-templates-block-hover-bg: var(--p-mask-background);
  --home-blocks-block-shadow: -10px 4px 10px 0px rgba(0, 0, 0, 0.1),
    -10px 4px 25px rgba(0, 0, 0, 0.1);
  ...
  --topbar-sticky-background: hsla(0, 0%, 100%, 0.7);
  ...
  --p-overlay-select-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1),
    0 2px 4px -2px rgba(0, 0, 0, 0.1);
  --p-overlay-popover-border-radius: var(--p-border-radius-md);
  --p-overlay-popover-padding: 0.75rem;
  --p-overlay-popover-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1),
    0 2px 4px -2px rgba(0, 0, 0, 0.1);
  --p-overlay-modal-border-radius: var(--p-border-radius-xl);
  --p-overlay-modal-padding: 1.25rem;
  --p-overlay-modal-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1),
    0 8px 10px -6px rgba(0, 0, 0, 0.1);
  --p-overlay-navigation-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1),
    0 2px 4px -2px rgba(0, 0, 0, 0.1);
  --p-surface-0: #ffffff;
  ...
  --p-highlight-background: var(--p-primary-950);
  ...
  --p-form-field-float-label-invalid-color: var(
    --p-form-field-invalid-placeholder-color
  );
  --p-form-field-icon-color: var(--p-surface-400);
  --p-form-field-shadow: 0 0 #0000, 0 0 #0000,
  ...
  --p-list-option-selected-focus-background: var(
  ...
  --p-accordion-header-last-bottom-border-radius: var(
  ...
  --p-button-raised-shadow: 0 3px 1px -2px rgba(0, 0, 0, 0.2),
  ...
  --p-autocomplete-filled-hover-background: var(
    --p-form-field-filled-hover-background
  );
  --p-autocomplete-filled-focus-background: var(
  ...
  --p-autocomplete-invalid-border-color: var(
  ...
  --p-autocomplete-invalid-placeholder-color: var(
    --p-form-field-invalid-placeholder-color
  );
  ...
  --p-autocomplete-option-focus-background: var(
    --p-list-option-focus-background
  );
  --p-autocomplete-option-selected-background: var(
  ...
  --p-autocomplete-option-selected-focus-color: var(
  ...
  --p-autocomplete-dropdown-hover-border-color: var(
    --p-form-field-border-color
  );
  --p-autocomplete-dropdown-active-border-color: var(
    --p-form-field-border-color
  );
  ...
  --p-message-info-background: color-mix(
    in srgb,
    var(--p-blue-50),
    transparent 5%
  );
  ...
  --p-message-info-shadow: 0px 4px 8px 0px
    color-mix(in srgb, var(--p-blue-500), transparent 96%);
  ...
  --p-message-success-background: color-mix(
    in srgb,
    var(--p-green-50),
    transparent 5%
  );
  ...
  --p-message-success-shadow: 0px 4px 8px 0px
    color-mix(in srgb, var(--p-green-500), transparent 96%);
  ...
  --p-message-warn-background: color-mix(
    in srgb,
    var(--p-yellow-50),
    transparent 5%
  );
  ...
  --p-message-warn-shadow: 0px 4px 8px 0px
    color-mix(in srgb, var(--p-yellow-500), transparent 96%);
  ...
  --p-message-error-background: color-mix(
    in srgb,
    var(--p-red-50),
    transparent 5%
  );
  ...
  --p-message-error-shadow: 0px 4px 8px 0px
    color-mix(in srgb, var(--p-red-500), transparent 96%);
  ...
  --p-message-secondary-shadow: 0px 4px 8px 0px
    color-mix(in srgb, var(--p-surface-500), transparent 96%);
  ...
  --p-message-contrast-shadow: 0px 4px 8px 0px
    color-mix(in srgb, var(--p-surface-950), transparent 96%);
  ...
  --p-breadcrumb-item-icon-hover-color: var(
  ...
  --p-card-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.1),
  ...
  --p-cascadeselect-disabled-background: var(
    --p-form-field-disabled-background
  );
  --p-cascadeselect-filled-background: var(--p-form-field-filled-background);
  --p-cascadeselect-filled-hover-background: var(
    --p-form-field-filled-hover-background
  );
  --p-cascadeselect-filled-focus-background: var(
    --p-form-field-filled-focus-background
  );
  ...
  --p-cascadeselect-invalid-border-color: var(
    --p-form-field-invalid-border-color
  );
  ...
  --p-cascadeselect-invalid-placeholder-color: var(
    --p-form-field-invalid-placeholder-color
  );
  ...
  --p-cascadeselect-transition-duration: var(
  ...
  --p-cascadeselect-overlay-border-radius: var(
  ...
  --p-cascadeselect-option-focus-background: var(
    --p-list-option-focus-background
  );
  --p-cascadeselect-option-selected-background: var(
    --p-list-option-selected-background
  );
  --p-cascadeselect-option-selected-focus-background: var(
    --p-list-option-selected-focus-background
  );
  ...
  --p-cascadeselect-option-selected-focus-color: var(
    --p-list-option-selected-focus-color
  );
  ...
  --p-cascadeselect-option-icon-focus-color: var(
  ...
  --p-confirmpopup-shadow: var(--p-overlay-popover-shadow);
  --p-confirmpopup-gutter: 10px;
  --p-confirmpopup-arrow-offset: 1.25rem;
  --p-confirmpopup-content-padding: var(--p-overlay-popover-padding);
  --p-confirmpopup-content-gap: 1rem;
  --p-confirmpopup-icon-size: 1.5rem;
  --p-confirmpopup-icon-color: var(--p-overlay-popover-color);
  --p-confirmpopup-footer-gap: 0.5rem;
  --p-confirmpopup-footer-padding: 0 var(--p-overlay-popover-padding)
    var(--p-overlay-popover-padding) var(--p-overlay-popover-padding);
  ...
  --p-contextmenu-item-focus-background: var(
    --p-navigation-item-focus-background
  );
  --p-contextmenu-item-active-background: var(
  ...
  --p-contextmenu-item-icon-focus-color: var(
    --p-navigation-item-icon-focus-color
  );
  --p-contextmenu-item-icon-active-color: var(
  ...
  --p-contextmenu-submenu-icon-focus-color: var(
    --p-navigation-submenu-icon-focus-color
  );
  --p-contextmenu-submenu-icon-active-color: var(
  ...
  --p-datatable-row-toggle-button-hover-background: var(
    --p-content-hover-background
  );
  --p-datatable-row-toggle-button-selected-hover-background: var(
  ...
  --p-datatable-filter-overlay-select-background: var(
    --p-overlay-select-background
  );
  --p-datatable-filter-overlay-select-border-color: var(
    --p-overlay-select-border-color
  );
  --p-datatable-filter-overlay-select-border-radius: var(
    --p-overlay-select-border-radius
  );
  ...
  --p-datatable-filter-overlay-popover-background: var(
    --p-overlay-popover-background
  );
  --p-datatable-filter-overlay-popover-border-color: var(
    --p-overlay-popover-border-color
  );
  --p-datatable-filter-overlay-popover-border-radius: var(
  ...
  --p-datatable-filter-overlay-popover-padding: var(
  ...
  --p-datatable-filter-constraint-focus-background: var(
    --p-list-option-focus-background
  );
  --p-datatable-filter-constraint-selected-background: var(
    --p-list-option-selected-background
  );
  ...
  --p-datatable-filter-constraint-selected-color: var(
    --p-list-option-selected-color
  );
  --p-datatable-filter-constraint-selected-focus-color: var(
    --p-list-option-selected-focus-color
  );
  --p-datatable-filter-constraint-separator-border-color: var(
    --p-content-border-color
  );
  --p-datatable-filter-constraint-padding: var(--p-list-option-padding);
  --p-datatable-filter-constraint-border-radius: var(
  ...
  --p-multiselect-filled-hover-background: var(
    --p-form-field-filled-hover-background
  );
  --p-multiselect-filled-focus-background: var(
    --p-form-field-filled-focus-background
  );
  ...
  --p-multiselect-invalid-border-color: var(
    --p-form-field-invalid-border-color
  );
  ...
  --p-multiselect-invalid-placeholder-color: var(
    --p-form-field-invalid-placeholder-color
  );
  ...
  --p-multiselect-option-focus-background: var(
    --p-list-option-focus-background
  );
  --p-multiselect-option-selected-background: var(
    --p-list-option-selected-background
  );
  --p-multiselect-option-selected-focus-background: var(
    --p-list-option-selected-focus-background
  );
  ...
  --p-multiselect-option-selected-focus-color: var(
    --p-list-option-selected-focus-color
  );
  ...
  --p-multiselect-option-group-background: var(
    --p-list-option-group-background
  );
  --p-multiselect-option-group-color: var(--p-list-option-group-color);
  --p-multiselect-option-group-font-weight: var(
    --p-list-option-group-font-weight
  );
  ...
  --p-selectbutton-invalid-border-color: var(
    --p-form-field-invalid-border-color
  );
  ...
  --p-inputtext-filled-hover-background: var(
    --p-form-field-filled-hover-background
  );
  --p-inputtext-filled-focus-background: var(
    --p-form-field-filled-focus-background
  );
  ...
  --p-inputtext-invalid-placeholder-color: var(
    --p-form-field-invalid-placeholder-color
  );
  ...
  --p-select-filled-hover-background: var(
    --p-form-field-filled-hover-background
  );
  --p-select-filled-focus-background: var(
    --p-form-field-filled-focus-background
  );
  ...
  --p-select-invalid-placeholder-color: var(
    --p-form-field-invalid-placeholder-color
  );
  ...
  --p-select-option-selected-background: var(
    --p-list-option-selected-background
  );
  ...
  --p-select-option-selected-focus-color: var(
    --p-list-option-selected-focus-color
  );
  ...
  --p-datepicker-select-month-hover-background: var(
    --p-content-hover-background
  );
  ...
  --p-datepicker-select-year-hover-background: var(
    --p-content-hover-background
  );
  ...
  --p-slider-handle-content-shadow: 0px 0.5px 0px 0px rgba(0, 0, 0, 0.08),
  ...
  --p-toggleswitch-invalid-border-color: var(
    --p-form-field-invalid-border-color
  );
  ...
  --p-toggleswitch-handle-disabled-background: var(
  ...
  --p-textarea-filled-focus-background: var(
    --p-form-field-filled-focus-background
  );
  ...
  --p-textarea-invalid-placeholder-color: var(
    --p-form-field-invalid-placeholder-color
  );
  ...
  --p-radiobutton-checked-disabled-border-color: var(
    --p-form-field-border-color
  );
  --p-radiobutton-invalid-border-color: var(
    --p-form-field-invalid-border-color
  );
  ...
  --p-dialog-content-padding: 0 var(--p-overlay-modal-padding)
    var(--p-overlay-modal-padding) var(--p-overlay-modal-padding);
  --p-dialog-footer-padding: 0 var(--p-overlay-modal-padding)
    var(--p-overlay-modal-padding) var(--p-overlay-modal-padding);
  ...
  --p-togglebutton-disabled-border-color: var(
    --p-form-field-disabled-background
  );
  --p-togglebutton-disabled-color: var(--p-form-field-disabled-color);
  --p-togglebutton-invalid-border-color: var(
    --p-form-field-invalid-border-color
  );
  ...
  --p-togglebutton-sm-padding: 0.375rem 0.75rem;
  --p-togglebutton-lg-font-size: var(--p-form-field-lg-font-size);
  --p-togglebutton-lg-padding: 0.625rem 1.25rem;
  ...
  --p-togglebutton-content-checked-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.02),
  ...
  --p-menubar-item-active-background: var(
    --p-navigation-item-active-background
  );
  ...
  --p-menubar-item-icon-active-color: var(
    --p-navigation-item-icon-active-color
  );
  ...
  --p-menubar-submenu-icon-focus-color: var(
    --p-navigation-submenu-icon-focus-color
  );
  --p-menubar-submenu-icon-active-color: var(
    --p-navigation-submenu-icon-active-color
  );
  ...
  --p-dock-background: rgba(255, 255, 255, 0.1);
  --p-dock-border-color: rgba(255, 255, 255, 0.2);
  ...
  --p-terminal-padding: var(--p-form-field-padding-y)
    var(--p-form-field-padding-x);
  ...
  --p-tree-node-toggle-button-hover-background: var(
    --p-content-hover-background
  );
  --p-tree-node-toggle-button-selected-hover-background: var(
    --p-content-background
  );
  ...
  --p-galleria-thumbnail-nav-button-border-radius: var(
    --p-content-border-radius
  );
  ...
  --p-galleria-thumbnail-nav-button-focus-ring-offset: var(
    --p-focus-ring-offset
  );
  --p-galleria-thumbnail-nav-button-focus-ring-shadow: var(
    --p-focus-ring-shadow
  );
  ...
  --p-galleria-inset-indicator-button-hover-background: rgba(
    255,
    255,
    255,
    0.6
  );
  --p-galleria-inset-indicator-button-active-background: rgba(
    255,
    255,
    255,
    0.9
  ...
  --p-drawer-content-padding: 0 var(--p-overlay-modal-padding)
    var(--p-overlay-modal-padding) var(--p-overlay-modal-padding);
  ...
  --p-editor-overlay-shadow: var(--p-overlay-select-shadow);
  --p-editor-overlay-padding: var(--p-list-padding);
  --p-editor-overlay-option-focus-background: var(
    --p-list-option-focus-background
  );
  --p-editor-overlay-option-color: var(--p-list-option-color);
  --p-editor-overlay-option-focus-color: var(--p-list-option-focus-color);
  --p-editor-overlay-option-padding: var(--p-list-option-padding);
  ...
  --p-password-meter-height: 0.75rem;
  ...
  --p-menu-submenu-label-font-weight: var(
    --p-navigation-submenu-label-font-weight
  );
  --p-menu-submenu-label-background: var(
  ...
  --p-image-transition-duration: var(--p-transition-duration);
  --p-image-preview-icon-size: 1.5rem;
  --p-image-preview-mask-background: var(--p-mask-background);
  --p-image-preview-mask-color: var(--p-mask-color);
  --p-image-toolbar-position-left: auto;
  --p-image-toolbar-position-right: 1rem;
  --p-image-toolbar-position-top: 1rem;
  --p-image-toolbar-position-bottom: auto;
  --p-image-toolbar-blur: 8px;
  --p-image-toolbar-background: rgba(255, 255, 255, 0.1);
  --p-image-toolbar-border-color: rgba(255, 255, 255, 0.2);
  --p-image-toolbar-border-width: 1px;
  --p-image-toolbar-border-radius: 30px;
  --p-image-toolbar-padding: 0.5rem;
  --p-image-toolbar-gap: 0.5rem;
  --p-image-action-hover-background: rgba(255, 255, 255, 0.1);
  --p-image-action-color: var(--p-surface-50);
  --p-image-action-hover-color: var(--p-surface-0);
  --p-image-action-size: 3rem;
  --p-image-action-icon-size: 1.5rem;
  --p-image-action-border-radius: 50%;
  --p-image-action-focus-ring-width: var(--p-focus-ring-width);
  --p-image-action-focus-ring-style: var(--p-focus-ring-style);
  --p-image-action-focus-ring-color: var(--p-focus-ring-color);
  --p-image-action-focus-ring-offset: var(--p-focus-ring-offset);
  --p-image-action-focus-ring-shadow: var(--p-focus-ring-shadow);
  --p-imagecompare-handle-size: 15px;
  --p-imagecompare-handle-hover-size: 30px;
  --p-imagecompare-handle-background: rgba(255, 255, 255, 0.3);
  --p-imagecompare-handle-hover-background: rgba(255, 255, 255, 0.3);
  --p-imagecompare-handle-border-color: unset;
  --p-imagecompare-handle-hover-border-color: unset;
  --p-imagecompare-handle-border-width: 0;
  --p-imagecompare-handle-border-radius: 50%;
  --p-imagecompare-handle-transition-duration: var(--p-transition-duration);
  --p-imagecompare-handle-focus-ring-width: var(--p-focus-ring-width);
  --p-imagecompare-handle-focus-ring-style: var(--p-focus-ring-style);
  --p-imagecompare-handle-focus-ring-color: rgba(255, 255, 255, 0.3);
  --p-imagecompare-handle-focus-ring-offset: var(--p-focus-ring-offset);
  --p-imagecompare-handle-focus-ring-shadow: var(--p-focus-ring-shadow);
  ...
  --p-inplace-padding: var(--p-form-field-padding-y)
    var(--p-form-field-padding-x);
  ...
  --p-listbox-option-selected-background: var(
    --p-list-option-selected-background
  );
  ...
  --p-listbox-option-selected-focus-color: var(
    --p-list-option-selected-focus-color
  );
  ...
  --p-megamenu-item-active-background: var(
    --p-navigation-item-active-background
  );
  ...
  --p-megamenu-item-icon-active-color: var(
    --p-navigation-item-icon-active-color
  );
  ...
  --p-megamenu-submenu-label-font-weight: var(
    --p-navigation-submenu-label-font-weight
  );
  --p-megamenu-submenu-label-background: var(
    --p-navigation-submenu-label-background-
  );
  ...
  --p-megamenu-submenu-icon-focus-color: var(
    --p-navigation-submenu-icon-focus-color
  );
  --p-megamenu-submenu-icon-active-color: var(
    --p-navigation-submenu-icon-active-color
  );
  ...
  --p-megamenu-mobile-button-hover-background: var(
    --p-content-hover-background
  );
  ...
  --p-organizationchart-node-hover-background: var(
    --p-content-hover-background
  );
  ...
  --p-organizationchart-node-toggle-button-background: var(
    --p-content-background
  );
  --p-organizationchart-node-toggle-button-hover-background: var(
    --p-content-hover-background
  );
  --p-organizationchart-node-toggle-button-border-color: var(
    --p-content-border-color
  );
  ...
  --p-organizationchart-node-toggle-button-focus-ring-width: var(
    --p-focus-ring-width
  );
  --p-organizationchart-node-toggle-button-focus-ring-style: var(
    --p-focus-ring-style
  );
  --p-organizationchart-node-toggle-button-focus-ring-color: var(
    --p-focus-ring-color
  );
  --p-organizationchart-node-toggle-button-focus-ring-offset: var(
    --p-focus-ring-offset
  );
  --p-organizationchart-node-toggle-button-focus-ring-shadow: var(
    --p-focus-ring-shadow
  );
  ...
  --p-panelmenu-gap: 0.5rem;
  --p-panelmenu-transition-duration: var(--p-transition-duration);
  ...
  --p-panelmenu-panel-padding: 0.25rem 0.25rem;
  ...
  --p-progressspinner-color-1: var(--p-red-500);
  --p-progressspinner-color-2: var(--p-blue-500);
  --p-progressspinner-color-3: var(--p-green-500);
  --p-progressspinner-color-4: var(--p-yellow-500);
  ...
  --p-splitbutton-raised-shadow: 0 3px 1px -2px rgba(0, 0, 0, 0.2),
    0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 1px 5px 0 rgba(0, 0, 0, 0.12);
  ...
  --p-stepper-step-number-shadow: 0px 0.5px 0px 0px rgba(0, 0, 0, 0.06),
  ...
  --p-tieredmenu-item-focus-background: var(
    --p-navigation-item-focus-background
  );
  --p-tieredmenu-item-active-background: var(
    --p-navigation-item-active-background
  );
  ...
  --p-tieredmenu-item-icon-focus-color: var(
    --p-navigation-item-icon-focus-color
  );
  --p-tieredmenu-item-icon-active-color: var(
    --p-navigation-item-icon-active-color
  );
  ...
  --p-tieredmenu-submenu-icon-focus-color: var(
    --p-navigation-submenu-icon-focus-color
  );
  --p-tieredmenu-submenu-icon-active-color: var(
    --p-navigation-submenu-icon-active-color
  );
  ...
  --p-timeline-event-marker-content-inset-shadow: 0px 0.5px 0px 0px
      rgba(0, 0, 0, 0.06),
    0px 1px 1px 0px rgba(0, 0, 0, 0.12);
  ...
  --p-treeselect-filled-hover-background: var(
    --p-form-field-filled-hover-background
  );
  --p-treeselect-filled-focus-background: var(
    --p-form-field-filled-focus-background
  );
  ...
  --p-treeselect-invalid-placeholder-color: var(
    --p-form-field-invalid-placeholder-color
  );
  ...
  --p-treetable-node-toggle-button-hover-background: var(
    --p-content-hover-background
  );
  --p-treetable-node-toggle-button-selected-hover-background: var(
    --p-content-background
  );
  ...
  --p-treetable-node-toggle-button-focus-ring-offset: var(
    --p-focus-ring-offset
  );
  --p-treetable-node-toggle-button-focus-ring-shadow: var(
    --p-focus-ring-shadow
  );
