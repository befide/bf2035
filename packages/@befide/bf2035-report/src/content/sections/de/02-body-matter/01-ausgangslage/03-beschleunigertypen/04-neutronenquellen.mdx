...
supertitle: Beschleuniger für die Forschung
title: Spallationsquellen
subtitle: für die Forschung mit Neutronen
---
...
Als beschleunigergetriebene Neutronenquelle ist ihr Protonenbeschleuniger eine entscheidende Komponente der ESS-Anlage. Rolle und Aufbau sind ziemlich geradlinig. Der Beschleuniger erzeugt Protonen in einer **Ionenquelle**, beschleunigt sie auf verschiedenen Etappen auf eine Energie von 2,5 GeV und lenkt sie auf eine Target aus Wolfram, um durch den Spallationsprozess Neutronen zu erzeugen.
...
Da es sich um eine skalierbare Neutronenquelle handelt, kann das Leistungsniveau von einer gepulsten Neutronenquelle mit geringer Leistung für Universitäten und Industrie mit einer durchschnittlichen Leistung am Zielort von etwa 1 Kilowatt bis zu einer Hochleistungsneutronenquelle mit ∼100 kW durchschnittlicher Leistung variieren, die als vollwertige nationale Anlage konzipiert ist.

12.3.1.2 Das HBS-Referenzdesign Das Jülich Center for Neutron Scattering am Forschungszentrum Jülich schlägt das Design einer High Brilliance Source (HBS) mit den folgenden Parametern vor: Ep = 70 MeV, Ipeak = 100 mA, P = 100 kW, Fixed Ta Target80.

12.3.1.5 Das NOVA-ERA Referenzdesign Das Jülich Center for Neutron Scattering am Forschungszentrum Jülich erwägt ebenfalls den Bau einer „Labor“-Quelle mit bescheidenen Leistungen NOVA-ERA: Neutrons Obtained Via Accelerator for Education and Research Activities.83 Die Designparameter sind Ep = 10 MeV, Ipeak = 1 mA, P = 1 kW, Be-Target, Tastverhältnis 4-10%. Eine solche Quelle kann mit handelsüblichen Protonenbeschleunigern gebaut werden.
