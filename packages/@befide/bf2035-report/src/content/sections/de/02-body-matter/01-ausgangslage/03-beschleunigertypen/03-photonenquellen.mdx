...
<ProgressChart dimension="pdbEntries">
  Entwicklung der Anzahl der Einträge in der **Protein-Datenbank (PDB)**, einer Sammlung dreidimensionaler Strukturdaten
  großer biologischer Moleküle wie Proteine und Nukleinsäuren[^pdb]
</ProgressChart>

<ProgressChart dimension="progress__peak_brilliance">
  Bei beschleunigerbetriebenen Lichtquellen beschreibt die **Brillanz** die Zahl der Photonen einer bestimmten
  Wellenlänge und Richtung pro Zeiteinheit und Fläche.[^6]
</ProgressChart>
