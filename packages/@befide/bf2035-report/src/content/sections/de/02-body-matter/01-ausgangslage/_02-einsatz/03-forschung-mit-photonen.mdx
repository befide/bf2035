...
<ProgressChart dimension="pdbEntries">
  Entwicklung der Anzahl der Einträge in der **Protein-Datenbank (PDB)**. Das
  PDB-Projekt wurde in den 1970er Jahren als Sammlung dreidimensionaler
  Strukturdaten großer biologischer Moleküle wie Proteine und Nukleinsäuren ins
  Leben gerufen. Datenquelle: PDB, erstellt durch: DR
</ProgressChart>
...
[^2]: <BibRef citeKey="biasci_bouteille_etal__2014__lowemittance" />
[^3]: <BibRef citeKey="jankowiak_knobloch_etal__2015__technical" />
[^4]: <BibRef citeKey="rohlsberger_schroer_etal__2019__light" />
[^5]: <BibRef citeKey="beye__2020__flash2020" />
[^6]: <BibRef citeKey="altarelli__2006__xfel" />
