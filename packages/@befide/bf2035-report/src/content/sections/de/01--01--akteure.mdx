...
<OrganisationList filter={({ type }) => type === "non-university-research-organisation"} />
...
<img class="md" src={communityMap.src} width="100%" alt="A rocketship in space." />
...
<div class="spread--left spread-area--references">

1. <BibRef citeKey="kfb__2022__mitgliederbefragung" />
2. Eigene Erhebung
3. <BibRef citeKey="dosch__2019__overview" />
4. <BibRef citeKey="komiteefurbeschleunigerphysik__2014__satzung" />
5. Eigene Erhebung auf Grundlage der <BibRef citeKey="kfb__2022__dissertationsdatenbank" />
6. <BibRef citeKey="statistischesbundesamt__2020__statistik" locator="Seite 36"/>
7. <BibRef citeKey="statistischesbundesamt__2020__personal" locator="Seite 288"/>
8. <BibRef citeKey="erdman__2019__challenges" />
