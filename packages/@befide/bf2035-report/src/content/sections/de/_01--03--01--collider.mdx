...
title__toc: Ring- und Linear-Collider
...
<div class="spread--right spread-area--references spread-area--small">

1. <BibRef citeKey="cern-esu-005"></BibRef>
2. <BibRef citeKey="thefcccollaboration_abada_etal__2019__fcc"></BibRef>
3. <BibRef citeKey="icfa__2022__pressemitteilung"></BibRef>
