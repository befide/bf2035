...
<ProgressChart dimension="pdbEntries">
  Entwicklung der Anzahl der Einträge in der **Protein-Datenbank (PDB)**. Das PDB-Projekt wurde in den 1970er Jahren als
  Sammlung dreidimensionaler Strukturdaten großer biologischer Moleküle wie Proteine und Nukleinsäuren ins Leben
  gerufen. Datenquelle: PDB, erstellt durch: DR
</ProgressChart>
